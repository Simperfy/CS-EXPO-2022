...
export default function ModalFaculty(faculty) {
    const [showModal, setShowModal] = React.useState(false);
    const { title, description, message } = faculty.faculty;

    console.log(title);
    return (
        <div className="bg-black flex justify-center items-center bg-opacity-50 fixed inset-0 z-50">
            <div className="bg-gray-200 z-60 text-black max-w-md py-1 px-2 rounded shadow-x1">
                <div className="flex justify-between items-center">
                    <h4>Confirm Delete?</h4>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </div>
                <div className="mt-2">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum suscipit deserunt at veritatis, deleniti nam aliquid esse excepturi! Deleniti minus excepturi reprehenderit. Incidunt, officiis. Quos blanditiis nulla aperiam reprehenderit facere.</p>
                </div>
                <div className="mt-3 flex justify-end space-x-3">
                    <button className="px-3 py-1 rounded hover:bg-red-300 hover:bg-opacity-50 hover:text-red-900">Cancel</button>
                    <button className="px-3 py-1 bg-red-800 text-gray-200 rounded">Delete</button>
                </div>
            </div>
        </div>
        // <div class="fixed z-50 justify-center items-center inset-0 sm:h-full">
